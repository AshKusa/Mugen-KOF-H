...
[State -1, Guard1]
type = ChangeState
triggerall = var(33) = 1 && p2bodydist x <= 50 && random <= 700
triggerall = StateType != A && P2statetype != C && P2Movetype = A
...
trigger1 = p2bodydist x <= 30 && p2statetype != A && p2statetype != L && statetype != A && p2stateno != 5201 && ctrl && random <= 500
...
trigger1 = stateno = 2100 && movecontact && fvar(29) > 1000
;----------------------------------------------------------------------------------------------------------------------------
; Running Three SDM
; Trigger1 = Trying to make opponent attack active time perform during Clark's starting invincibility time
...
type = ChangeState
value = 8800
triggerall = p2stateno != 5040 && p2movetype = A 
triggerall = var(33) = 1
triggerall = power >= 2000 && numhelper(8810) = 0 && numhelper(9440) = 0
triggerall = p2statetype != C && p2bodydist x >=120
trigger1 = statetype !=A && ctrl && random <= 100
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
; Striker HSDM : Umanori Galactica Phantom
; Trigger1 = Launch it without any reason at all >:P
; Trigger2 = Launch it while running (confuses opponent with UAB/SAB)

[State -1, SSDM]
type = ChangeState
value = 8900
triggerall = p2stateno != 5040 && var(33) = 1
...
type = ChangeState
value = 1000
triggerall = (p2stateno != [5000,5299]) && p2movetype !=H && p2statetype !=L
triggerall = var(33) = 1 && statetype != A && ctrl
trigger1 = enemy, vel y > 0 && random <= 200
trigger1 = p2bodydist x <= 60 && p2bodydist y >= -85 && p2statetype = A && p2movetype !=H && random <= 200
trigger2 = p2bodydist x <= 30 && p2statetype !=A && var(14) <= 0 && random <= 200
...
value = 440
ctrl = 0
triggerall = p2stateno != 5040 && var(33) = 1 && statetype != A && ctrl
trigger1 = p2bodydist x <= 45 && random <= 200 && p2statetype != A && p2movetype != H && random <= 100
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
...
trigger1 = (p2bodydist x <= 25) && random <= 400 && p2statetype != L && p2statetype != A && ctrl
...
value = 240
ctrl = 0
triggerall = p2stateno != 5040 && var(33) = 1 && statetype != A
triggerall = p2stateno != 5120 && ctrl
trigger1 = (p2bodydist x=[40,60]) && p2movetype != H && random <= 50 
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
...
triggerall = var(33) = 1&& statetype = S
triggerall = p2stateno != 5120 && ctrl
trigger1 = p2bodydist x <= 25 && (p2bodydist y >=-90) && p2statetype != A && p2movetype != H && random <= 50 
;----------------------------------------------------------------------------------------------------------------------------
...
triggerall = p2stateno != 5040
triggerall = var(33) = 1&& statetype = S && ctrl
trigger1 = (p2bodydist x <= 20) && p2statetype != A && p2movetype != H && p2statetype !=L && random <= 600 ;&& p2movetype != A
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
...
ctrl = 0
triggerall = p2stateno != 5040
triggerall = var(33) = 1 && (p2bodydist x <= 50)
...
value = 300
triggerall = p2stateno != 5040
triggerall = var(33) = 1&& random <= 400
triggerall = statetype = A && ctrl
...
value = 4350
triggerall = p2stateno != 5040
triggerall = var(33) = 1= 1&& statetype != A && ctrl
...
value = 1500
triggerall = p2stateno != 5040
triggerall = var(33) = 1= 1&& statetype = S && p2movetype != A
...
ctrl = 0
triggerall = p2stateno != 5040
triggerall = var(33) = 1= 1&& statetype = S
...
trigger6 = stateno = 400 && animelemtime(2) > 0 && animelemtime(3) < 0 && movehit
...
trigger1 = p2bodydist x > 60 && p2movetype = A && random <= 100
trigger2 = p2bodydist x > 30 && p2movetype != A && random <= 100
trigger3 = p2bodydist x > 60 && p2movetype = H && p2statetype = A && var(10) > 0
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
[State -1,Run]
type = ChangeState
value = 20
triggerall = var(33) = 1 && roundstate = 2 && var(14) > 0
triggerall = statetype = S && ctrl && stateno != 20
trigger1 = p2bodydist x > 60 && p2movetype = A && random <= 250
;----------------------------------------------------------------------------------------------------------------------------
;----------------------------------------------------------------------------------------------------------------------------
[State -1,Taunt]
type = ChangeState
...
type = ChangeState
value = 700
triggerall = var(33) = 1&& statetype != A && ctrl && p2movetype = A && random <= 100
...
trigger1 = P2StateType = A && P2MoveType != H && P2BodyDist X <= 50 && (p2bodydist y = [-35,35])
;----------------------------------------------------------------------------------------------------------------------------
...
type = ChangeState
value = 3600
triggerall = command = "終極克拉克破壞者"
triggerall = statetype != A
triggerall = power >= 2000 
trigger1 = fvar(30) > 0
trigger1 = ctrl
trigger2 = stateno = 1500 && movecontact && fvar(29) > 1000
trigger3 = stateno = 1490 && movecontact && fvar(29) > 1000
trigger4 = stateno = 2100 && movecontact && fvar(29) > 1000

[State -1]
type = ChangeState
value = 3500
triggerall = command = "3500" && FVar(1) <= 0
triggerall = statetype != A
triggerall = power >= ifelse(fvar(30) > 0,1000,2000) && var(33) !=1
triggerall = fvar(31) = 0
trigger1 = ctrl
trigger2 = stateno = 1500 && AnimElemtime(10) > 0 && AnimElemtime(15) < 0 && movecontact
trigger3 = stateno = 1490 && AnimElemtime(10) > 0 && AnimElemtime(15) < 0 && movecontact
trigger4 = stateno = 4101 && AnimElemtime(11) > 0 && AnimElemtime(15) < 0 && movecontact

[State -1]
type = ChangeState
value = 36000
triggerall = command = "3600" && FVar(1) <= 0
triggerall = statetype != A
...
trigger8 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
trigger9 = stateno = 4101 && movecontact
trigger10 = (stateno=1500 || stateno=2100 || stateno = 4101) && movecontact
...
triggerall = power >= ifelse(fvar(30) > 0,0,1000) && var(33) !=1
trigger1 = statetype != A && ctrl
trigger2 = stateno = 211 && animelemtime(3) >=0 && animelemtime(4) < 0 && movecontact
trigger3 = stateno = 202 && animelemtime(2) >=0 && animelemtime(3) < 0 && movecontact
trigger4 = stateno = 400 && animelemtime(2) >=0 && animelemtime(3) < 0 && movecontact
...
trigger5 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
trigger1 = fvar(30) > 0
trigger1 = statetype != A && ctrl
trigger2 = stateno = 1500 && AnimElemtime(10) > 0 && AnimElemtime(15) < 0 && movecontact && fvar(29) > 1000
trigger3 = stateno = 1490 && AnimElemtime(10) > 0 && AnimElemtime(15) < 0 && movecontact && fvar(29) > 1000
trigger4 = stateno = 2100 && movecontact && fvar(29) > 1000
...
trigger11 = stateno = 7707 && animelemtime(2) >=0 && animelemtime(3) < 0 ;&& FVar(1) > 0 ; Ralf Mode Cancel
trigger12 = stateno = 7704 && animelemtime(4) >=0 && animelemtime(5) < 0 ;&& FVar(1) > 0 ; Ralf Mode Cancel
trigger13 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger14 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
type = ChangeState
value = 950
triggerall = command = "ifelbow" && var(7) = 1 && var(33) !=1 && FVar(1) <= 0
trigger1 = stateno = 903
trigger1 = time = [30,50]
...
trigger8 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger9 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
trigger7 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger8 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
;---------------
; Napalm Stretch
;---------------
...
trigger6 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger7 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
trigger3 = stateno = 250 && animelemtime(7) >=0 && animelemtime(8) < 0
trigger4 = (stateno = 100||stateno=101)
trigger5 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger6 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
trigger9 = stateno = 2100 && animelemtime(2) >=0 && animelemtime(4) < 0 && movecontact
trigger10= stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
...
type = ChangeState
value = 4300
triggerall = command = "counterH" && var(33) !=1 && FVar(1) <= 0 && !var(27)
trigger1 = statetype != A && ctrl
trigger2 = (stateno = 100||stateno=101)
trigger3 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
;--------------
; Counter : Low
;--------------
...
type = ChangeState
value = 4350
triggerall = command = "counterL" && var(33) !=1 && FVar(1) <= 0 && !var(27)
trigger1 = statetype != A && ctrl
trigger2 = (stateno = 100||stateno=101)
trigger3 = stateno = 410 && animelemtime(3) >=0 && animelemtime(5) < 0 && movecontact
;----------------
...
type = ChangeState
value = 2100
triggerall = command = "shoulder" && var(33) !=1 && FVar(1) <= 0 && !var(29)
trigger1 = statetype != A && ctrl
trigger2 = stateno = 211 && animelemtime(3) >=0 && animelemtime(4) < 0 && movecontact
trigger3 = stateno = 202 && animelemtime(2) >=0 && animelemtime(3) < 0 && movecontact
trigger4 = stateno = 400 && animelemtime(2) >=0 && animelemtime(3) < 0 && movecontact
...
[State -1, DLake Drive] ; Punch Version
type = ChangeState
value = 1850
...
[State -1, DLake Drive] ; Kick Version
type = ChangeState
value = 1851
...
trigger3 = (stateno = 100||stateno=101)
trigger4 = stateno = 400 && animelemtime(2) >=0 && animelemtime(3) < 0; && FVar(1) > 0 ; Cancel for Ralf Mode
...
type = ChangeState
value = 610
triggerall = command = "y" && var(33) != 1 && FVar(1) <= 0 && command != "holddown"
trigger1 = statetype = A && ctrl 
...
type = ChangeState
value = 641
triggerall = command = "b"  && command != "holddown" && var(33) != 1 && FVar(1) <= 0
trigger1 = statetype = A && ctrl
