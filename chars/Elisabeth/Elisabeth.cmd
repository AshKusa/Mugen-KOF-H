...
trigger5 = stateno = 1150 && movecontact
trigger6 = stateno = 1505 && movecontact && time >= 65
...
trigger5 = stateno = 1505 && movecontact && time >= 65
trigger6 = stateno = 2000 && movecontact

[State -1, Ex Shell Tware]
type = ChangeState
value = 3900
triggerall = var(50) = 0
triggerall = enemy,var(46) = 0
triggerall = command = "高貴描绘"
...
triggerall = var(50) = 0
triggerall = enemy,var(46) = 0
triggerall = command = "Ex Shell Tware"
